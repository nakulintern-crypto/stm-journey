...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NUM_IRQS, 72);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REALTEK_BEE_NVIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REALTEK_BEE_COMMON_DRIVER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_WRAP_REALTEK_BEE_NVIC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F446ZE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_NUCLEO_F446ZE_STM32F446XX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_BACKUP_SRAM, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STM32_BACKUP_SRAM_INIT_PRIORITY, 90);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_TRANSFER_TIMEOUT_SUPPORTED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_TRANSFER_TIMEOUT_MS, 500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_I2C_STM32_WAIT_BUS_IDLE_TIMEOUT_USEC, 2000);
