...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_get;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_get_config;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_get_raw;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_interrupt_configure;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_set;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_set_raw;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_pin_toggle;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_clear_bits;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_clear_bits_raw;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_get;
...
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_set_bits;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_set_bits_raw;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_set_clr_bits;
extern __weak ALIAS_OF(no_syscall_impl) void * const z_impl_gpio_port_set_clr_bits_raw;
