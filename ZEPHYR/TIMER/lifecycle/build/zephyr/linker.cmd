...
MEMORY
    ...
    RAM (wx) : ORIGIN = (536870912), LENGTH = (131072)
    BACKUP_SRAM ( rw ) : ORIGIN = (1073889280), LENGTH = (4096) SRAM0 ( rw ) : ORIGIN = (536870912), LENGTH = (131072)
...
noinit (NOLOAD) :
{
    ...
    __kernel_ram_end = (536870912) + (131072);
