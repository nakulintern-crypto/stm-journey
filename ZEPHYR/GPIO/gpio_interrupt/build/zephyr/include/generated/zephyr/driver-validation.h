...
#define K_SYSCALL_DRIVER_BUZZER(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, buzzer, BUZZER)
...
#define K_SYSCALL_DRIVER_DALI(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, dali, DALI)
...
#define K_SYSCALL_DRIVER_EMUL_ESPI(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, emul_espi, EMUL_ESPI)
...
#define K_SYSCALL_DRIVER_EMUL_MSPI(ptr, op) K_SYSCALL_DRIVER_GEN(ptr, op, emul_mspi, EMUL_MSPI)
